...
export class CalculadoraComponent implements OnInit {
  ...
  /**
   * Adiciona o numero selecionado para o calculo posteriomente
   *
   * @param string numero
   * @return void
   */
  public adicionaNumero(numero: string): void {
  ...
  public concatenarNumero(numAtual: string, numConcat: string): string {
    ...
    if (numConcat === '.' && numConcat.indexOf('.') > -1) {
      return numAtual;
    }
